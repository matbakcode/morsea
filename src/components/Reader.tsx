...
function Reader() {
  ...
  function addCurrentSignalSymbol(signalSymbol: SignalTypes) {
    console.log("addCurrentSignalSymbol")
      ...
      <div className={"flex flex-wrap flex-col justify-center align-middle"}>
        ...
        <div>
          <div className={"mt-6 min-h-12"}>
            <div
                className={
                  "mt-6 min-h-12 flex flex-wrap justify-center items-center text-xl tracking-wider"
                }
            >
        ...
        <div className={"min-h-12 flex items-center justify-center text-slate-400 text-xl"}>
          {messageSignal.length > 0 && <IoArrowDownSharp/>}
        </div>

        {/*Decoded Message*/}
        <div className={"min-h-12 flex text-center items-center justify-center text-xl tracking-wider"}>
        ...
        <div className={"mt-12 gap-8 flex justify-center items-center align-middle"}>
          <Button onClick={clearMessage}><MdOutlineCleaningServices/> clear</Button>
          <ActionController
              stage={stage}
              setStage={setStage}
              addCurrentSignalSymbol={addCurrentSignalSymbol}
          />
          <Button onClick={backspaceMessage}><MdOutlineBackspace/> back</Button>
        </div>
